      ...
      <Section className="bg-[#081a30] text-white">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-ink-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            Nos gemmologues vous accueillent à Nice au Carré d'Or sur rendez-vous ou organisent un déplacement sécurisé sur toute la Côte d'Azur (Saint-Jean-Cap-Ferrat, Monaco, Cannes).
          </p>
