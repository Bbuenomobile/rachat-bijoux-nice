    ...
    <header className="sticky top-0 z-50 bg-[#081a30]/95 backdrop-blur border-b border-white/10 text-white">
      <div className="container-x flex items-center justify-between h-20">
        ...
        <nav className="hidden xl:flex items-center gap-6 text-xs uppercase tracking-wider font-medium text-ink-200">
          <Link href="/rachat-diamant-nice" className="hover:text-white transition-colors">Diamants GIA</Link>
          <Link href="/rachat-haute-joaillerie-signee-nice" className="hover:text-white transition-colors">Haute Joaillerie</Link>
          <Link href="/rachat-bijoux-anciens-nice" className="hover:text-white transition-colors">Bijoux d'Époque</Link>
          <Link href="/rachat-montres-luxe-nice" className="hover:text-white transition-colors">Montres de Luxe</Link>
          <Link href="/rachat-lingots-pieces-or-nice" className="hover:text-white transition-colors">Or & Lingots</Link>
          <Link href="/laboratoire-gemmologique-nice" className="hover:text-white transition-colors">Laboratoire</Link>
          <Link href="/comment-ca-marche" className="hover:text-white transition-colors">Processus</Link>
